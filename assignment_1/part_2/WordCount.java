...
public class WordCount {
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  //For outputting date with the required format
    ...
    Job job = Job.getInstance(conf, "Number Count"); //change to number count
    ...
    System.out.print("Programmer: Chua Weng Kin\nStudent ID: 106214072\nProgram Executed at: " + dateFormat.format(currentDate) + "\n");
